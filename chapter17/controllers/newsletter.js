...
module.exports = {
    registerRoutes: function(app) {
        app.get('/newsletter-normal', this.getNewsletterNormal);
        app.get('/newsletter-ajax', this.getNewsletterAjax);
        app.post('/newsletter', this.postNewsletter);
        app.get('/newsletter/archive', this.getNewsletterArchive);
        app.post('/process-normal', this.postProcessNormal);
        app.post('/process-ajax', this.postProcessAjax);
    },
    getNewsletterNormal: (req, res) => {
        res.render('newsletter/newsletter-normal', {csrf: 'CSRF token goes here'});
    },
    getNewsletterAjax: (req, res) => {
    ...
    getNewsletterArchive: (req, res) => {
        res.render('newsletter/archive');
    },
    postProcessNormal: (req, res) => {
